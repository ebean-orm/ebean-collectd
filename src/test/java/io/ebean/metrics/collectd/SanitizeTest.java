...
public class SanitizeTest {
  ...
  @Test
  public void notReplacementRequired() {
    assertThat(Sanitize.name("foo.bar.baz")).isEqualTo("foo.bar.baz");
  }

  @Test
  public void replacesIllegalCharactersInName() {
    assertThat(Sanitize.name("foo\u0000bar/baz-quux")).isEqualTo("foo_bar_baz_quux");
  }

  @Test
  public void replacesIllegalCharactersInInstanceName() {
    assertThat(Sanitize.instanceName("foo\u0000bar/baz-quux")).isEqualTo("foo_bar_baz-quux");
  }

  @Test
  public void truncatesNamesExceedingMaxLength() {
  ...
  @Test
  public void replacesNonASCIICharacters() {
